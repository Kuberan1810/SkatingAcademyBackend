...
def global_search(
    ...
    for payment, student, batch in payments:
        ...
        elif search_student_name.startswith(
            query
        ):
        ...
        results.append(
            {
                ...
                "subtitle":
                    (
                        f"{fee_month_name} "
                        f"{payment.fee_year} Fee"
                    ),

                "meta":
                    (
                        f"₹{int(payment.net_payable):,}"
                        f" • "
